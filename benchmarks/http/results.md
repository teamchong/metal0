...
**Date:** 2025-11-27  
**System:** macOS ARM64  
**Library:** `requests` (same Python code for metal0/Python/PyPy)
...
| `metal0` | 17.810 ± 3.504 | 14.070 | 21.016 | 1.71 ± 0.50 |
...
| metal0 | 0.225s | 0.079s | 0.304s |
| PyPy | 0.696s | 0.110s | 0.806s |
| Python | 1.318s | 0.120s | 1.438s |

**Key Finding:** metal0 uses **4.7x less CPU** than Python (0.304s vs 1.438s)

## Libraries Used

| Language | HTTP Library |
|----------|--------------|
| Python/PyPy/metal0 | `requests` (same code) |
| Go | `net/http` (stdlib) |
...
- **metal0 uses 4.7x less CPU** than Python while handling same workload
- **Go/Rust win** due to mature HTTP clients with connection pooling
- **Same Python code** works on metal0, Python, and PyPy
