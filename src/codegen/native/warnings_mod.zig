...
pub const Funcs = std.StaticStringMap(h.H).initComptime(.{
    ...
    .{ "resetwarnings", h.c("{}") }, .{ "catch_warnings", h.c("struct { record: bool = false, log: std.ArrayList([]const u8) = .{}, pub fn __enter__(__self: *@This()) *@This() { return __self; } pub fn __exit__(__self: *@This(), _: anytype) void { _ = __self; } pub fn close(_: @This()) void {} }{}") },
