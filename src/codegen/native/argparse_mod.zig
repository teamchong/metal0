...
pub const Funcs = std.StaticStringMap(ModuleHandler).initComptime(.{
    .{ "ArgumentParser", genConst(ArgumentParserStruct) }, .{ "Namespace", genConst(NamespaceStruct) },
    .{ "FileType", genConst("\"r\"") }, .{ "REMAINDER", genConst("\"...\"") }, .{ "SUPPRESS", genConst("\"==SUPPRESS==\"") },
    .{ "OPTIONAL", genConst("\"?\"") }, .{ "ZERO_OR_MORE", genConst("\"*\"") }, .{ "ONE_OR_MORE", genConst("\"+\"") },
});
