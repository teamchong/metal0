...
pub const Funcs = std.StaticStringMap(ModuleHandler).initComptime(.{
    ...
    .{ "goto", genGoto },
    .{ "setpos", genSetpos },
    .{ "setposition", genSetposition },
    .{ "setx", genSetx },
    .{ "sety", genSety },
    .{ "setheading", genSetheading },
    .{ "seth", genSeth },
    .{ "home", genHome },
    .{ "circle", genCircle },
    .{ "dot", genDot },
    .{ "stamp", genStamp },
    .{ "clearstamp", genClearstamp },
    .{ "clearstamps", genClearstamps },
    .{ "undo", genUndo },
    .{ "speed", genSpeed },
    ...
    .{ "pensize", genPensize },
    .{ "width", genWidth },
    .{ "pencolor", genPencolor },
    .{ "fillcolor", genFillcolor },
    .{ "color", genColor },
    .{ "filling", genFilling },
    .{ "begin_fill", genBeginFill },
    .{ "end_fill", genEndFill },
    .{ "reset", genReset },
    .{ "clear", genClear },
    .{ "write", genWrite },
    .{ "showturtle", genShowturtle },
    .{ "st", genSt },
    .{ "hideturtle", genHideturtle },
    .{ "ht", genHt },
    .{ "isvisible", genIsvisible },
    .{ "shape", genShape },
    .{ "shapesize", genShapesize },
    .{ "turtlesize", genTurtlesize },
    .{ "bgcolor", genBgcolor },
    .{ "bgpic", genBgpic },
    .{ "done", genDone },
    .{ "mainloop", genMainloop },
    .{ "exitonclick", genExitonclick },
    .{ "bye", genBye },
    .{ "tracer", genTracer },
    .{ "update", genUpdate },
    .{ "delay", genDelay },
    ...
    .{ "getcanvas", genGetcanvas },
    .{ "getshapes", genGetshapes },
    .{ "register_shape", genRegisterShape },
    .{ "addshape", genAddshape },
    .{ "turtles", genTurtles },
    .{ "window_height", genWindowHeight },
    .{ "window_width", genWindowWidth },
    .{ "setup", genSetup },
    .{ "title", genTitle },
});
