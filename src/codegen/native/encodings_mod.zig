...
pub const Funcs = std.StaticStringMap(ModuleHandler).initComptime(.{
    .{ "search_function", genSearch }, .{ "normalize_encoding", genNormalize }, .{ "CodecInfo", genCodec }, .{ "aliases", genAliases },
});

fn genConst(self: *NativeCodegen, args: []ast.Node, v: []const u8) CodegenError!void { _ = args; try self.emit(v); }
fn genCodec(self: *NativeCodegen, args: []ast.Node) CodegenError!void { try genConst(self, args, ".{ .encode = null, .decode = null, .streamreader = null, .streamwriter = null, .incrementalencoder = null, .incrementaldecoder = null, .name = \"\" }"); }
fn genAliases(self: *NativeCodegen, args: []ast.Node) CodegenError!void { try genConst(self, args, ".{ .ascii = \"ascii\", .utf_8 = \"utf-8\", .utf_16 = \"utf-16\", .utf_32 = \"utf-32\", .latin_1 = \"iso8859-1\", .iso_8859_1 = \"iso8859-1\" }"); }
