...
pub const Funcs = std.StaticStringMap(h.H).initComptime(.{
    .{ "ip_address", h.structBlk("ipa", ".address = __v, .version = @as(i32, 4)", ".{ .address = \"0.0.0.0\", .version = @as(i32, 4) }") },
    .{ "ip_network", h.structBlk("ipn", ".network_address = __v, .prefixlen = @as(i32, 24), .version = @as(i32, 4)", ".{ .network_address = \"0.0.0.0\", .prefixlen = @as(i32, 0), .version = @as(i32, 4) }") },
    .{ "ip_interface", h.structBlk("ipi", ".ip = .{ .address = __v }, .network = .{ .network_address = __v, .prefixlen = @as(i32, 24) }", ".{ .ip = .{ .address = \"0.0.0.0\" }, .network = .{ .network_address = \"0.0.0.0\", .prefixlen = @as(i32, 0) } }") },
    .{ "IPv4Address", h.structBlk("ip4a", ".address = __v, .version = @as(i32, 4), .max_prefixlen = @as(i32, 32), .packed = &[_]u8{0, 0, 0, 0}", ".{ .address = \"0.0.0.0\", .version = @as(i32, 4), .max_prefixlen = @as(i32, 32), .packed = &[_]u8{0, 0, 0, 0} }") },
    ...
    .{ "IPv6Address", h.structBlk("ip6a", ".address = __v, .version = @as(i32, 6), .max_prefixlen = @as(i32, 128), .packed = &[_]u8{0} ** 16", ".{ .address = \"::\", .version = @as(i32, 6), .max_prefixlen = @as(i32, 128), .packed = &[_]u8{0} ** 16 }") },
