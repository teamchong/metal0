...
pub const Funcs = std.StaticStringMap(h.H).initComptime(.{
    .{ "module_spec", h.structBlk("mspec", ".name = __v, .loader = null, .origin = null, .submodule_search_locations = null", ".{ .name = \"\", .loader = null, .origin = null, .submodule_search_locations = null }") }, .{ "builtin_importer", h.c(".{}") }, .{ "frozen_importer", h.c(".{}") },
