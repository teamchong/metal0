...
pub const Funcs = std.StaticStringMap(h.H).initComptime(.{
    ...
    .{ "Differ", h.c("struct { pub fn compare(__self: @This(), a: [][]const u8, b: [][]const u8) [][]const u8 { _ = &__self; _ = a; _ = b; return &[_][]const u8{}; } }{}") },
    .{ "HtmlDiff", h.c("struct { tabsize: i64 = 8, pub fn make_file(__self: @This(), fromlines: anytype, tolines: anytype) []const u8 { _ = &__self; _ = fromlines; _ = tolines; return \"\"; } pub fn make_table(__self: @This(), fromlines: anytype, tolines: anytype) []const u8 { _ = &__self; _ = fromlines; _ = tolines; return \"\"; } }{}") },
