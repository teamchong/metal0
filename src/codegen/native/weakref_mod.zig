...
pub const Funcs = std.StaticStringMap(h.H).initComptime(.{
    ...
    .{ "WeakSet", h.c("struct { items: std.ArrayList(*anyopaque) = .{}, pub fn add(__self: *@This(), item: anytype) void { __self.items.append(__global_allocator, @ptrCast(&item)) catch {}; } pub fn discard(__self: *@This(), item: anytype) void { _ = __self; _ = item; } pub fn __len__(__self: *@This()) usize { return __self.items.items.len; } pub fn __contains__(__self: *@This(), item: anytype) bool { _ = __self; _ = item; return false; } }{}") },
