...
const genBytesIO = h.wrap("blk: { const init = ", "; var bio: std.ArrayList(u8) = .{}; bio.appendSlice(metal0_allocator, init) catch {}; break :blk .{ .buffer = bio, .pos = 0 }; }", ".{ .buffer = .{}, .pos = 0 }");
const genStringIO = h.wrap("blk: { const init = ", "; var sio: std.ArrayList(u8) = .{}; sio.appendSlice(metal0_allocator, init) catch {}; break :blk .{ .buffer = sio, .pos = 0 }; }", ".{ .buffer = .{}, .pos = 0 }");
