...
pub const Funcs = std.StaticStringMap(ModuleHandler).initComptime(.{
    .{ "Queue", genQueue }, .{ "LifoQueue", genLifoQueue }, .{ "PriorityQueue", genQueue }, .{ "SimpleQueue", genQueue },
    .{ "Empty", genEmpty }, .{ "Full", genFull },
});
...
fn genQueue(self: *NativeCodegen, args: []ast.Node) CodegenError!void { try genConst(self, args, QueueStruct); }
fn genLifoQueue(self: *NativeCodegen, args: []ast.Node) CodegenError!void { try genConst(self, args, LifoQueueStruct); }
fn genEmpty(self: *NativeCodegen, args: []ast.Node) CodegenError!void { try genConst(self, args, "\"Empty\""); }
fn genFull(self: *NativeCodegen, args: []ast.Node) CodegenError!void { try genConst(self, args, "\"Full\""); }
