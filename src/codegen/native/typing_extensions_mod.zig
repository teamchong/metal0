...
pub const Funcs = std.StaticStringMap(ModuleHandler).initComptime(.{
    .{ "Annotated", genAnnotated },
    .{ "ParamSpec", genParamSpec },
    .{ "ParamSpecArgs", genParamSpecArgs },
    .{ "ParamSpecKwargs", genParamSpecKwargs },
    .{ "Concatenate", genConcatenate },
    .{ "TypeAlias", genTypeAlias },
    .{ "TypeGuard", genTypeGuard },
    .{ "TypeIs", genTypeIs },
    .{ "Self", genSelf },
    .{ "Never", genNever },
    .{ "Required", genRequired },
    .{ "NotRequired", genNotRequired },
    .{ "LiteralString", genLiteralString },
    .{ "Unpack", genUnpack },
    .{ "TypeVarTuple", genTypeVarTuple },
    .{ "override", genOverride },
    .{ "final", genFinal },
    .{ "deprecated", genDeprecated },
    .{ "dataclass_transform", genDataclass_transform },
    .{ "runtime_checkable", genRuntime_checkable },
    .{ "Protocol", genProtocol },
    .{ "TypedDict", genTypedDict },
    .{ "NamedTuple", genNamedTuple },
    .{ "get_type_hints", genGet_type_hints },
    .{ "get_origin", genGet_origin },
    .{ "get_args", genGet_args },
    .{ "is_typeddict", genIs_typeddict },
    .{ "get_annotations", genGet_annotations },
    .{ "assert_type", genAssert_type },
    .{ "reveal_type", genReveal_type },
    .{ "assert_never", genAssert_never },
    .{ "clear_overloads", genClear_overloads },
    .{ "get_overloads", genGet_overloads },
    .{ "Doc", genDoc },
    .{ "ReadOnly", genReadOnly },
    .{ "Any", genAny },
    .{ "Union", genUnion },
    ...
    .{ "Type", genType },
    .{ "Literal", genLiteral },
    .{ "ClassVar", genClassVar },
    .{ "TypeVar", genTypeVar },
    .{ "Generic", genGeneric },
    .{ "NoReturn", genNoReturn },
    .{ "cast", genCast },
    .{ "overload", genOverload },
    .{ "no_type_check", genNo_type_check },
    .{ "TYPE_CHECKING", genTYPE_CHECKING },
});
