...
pub fn createDefaultRegistry(allocator: std.mem.Allocator) !ImportRegistry {
    ...
    try registry.register("marshal", .zig_runtime, null, null); // Dispatch only, no runtime lib
    try registry.register("warnings", .zig_runtime, null, null); // Dispatch only, no runtime lib
    ...
    try registry.register("_ast", .zig_runtime, null, null);
    try registry.register("_asyncio", .zig_runtime, null, null);
    try registry.register("_bisect", .zig_runtime, null, null);
    try registry.register("_collections", .zig_runtime, null, null);
    try registry.register("_contextvars", .zig_runtime, null, null);
    try registry.register("_csv", .zig_runtime, null, null);
    try registry.register("_datetime", .zig_runtime, null, null);
    try registry.register("_decimal", .zig_runtime, null, null);
    try registry.register("_elementtree", .zig_runtime, null, null);
    try registry.register("_functools", .zig_runtime, null, null);
    try registry.register("_hashlib", .zig_runtime, null, null);
    try registry.register("_heapq", .zig_runtime, null, null);
    try registry.register("_json", .zig_runtime, null, null);
