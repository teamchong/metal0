...
pub const Funcs = std.StaticStringMap(ModuleHandler).initComptime(.{
    ...
    .{ "w__o_k", genW_OK },
    .{ "x__o_k", genX_OK },
    .{ "o__r_d_o_n_l_y", genO_RDONLY },
    .{ "o__w_r_o_n_l_y", genO_WRONLY },
    .{ "o__r_d_w_r", genO_RDWR },
    .{ "o__a_p_p_e_n_d", genO_APPEND },
    .{ "o__c_r_e_a_t", genO_CREAT },
    .{ "o__t_r_u_n_c", genO_TRUNC },
    .{ "o__e_x_c_l", genO_EXCL },
    .{ "o__b_i_n_a_r_y", genO_BINARY },
    .{ "o__t_e_x_t", genO_TEXT },
    .{ "sep", genSep },
    .{ "altsep", genAltsep },
    .{ "extsep", genExtsep },
    .{ "pathsep", genPathsep },
