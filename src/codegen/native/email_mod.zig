...
const genEmailMessage = h.c("struct { headers: hashmap_helper.StringHashMap([]const u8), body: []const u8 = \"\", pub fn init() @This() { return @This(){ .headers = hashmap_helper.StringHashMap([]const u8).init(__global_allocator) }; } pub fn set_content(__self: *@This(), content: []const u8) void { __self.body = content; } pub fn get_content(__self: *@This()) []const u8 { return __self.body; } pub fn get_body(__self: *@This()) []const u8 { return __self.body; } pub fn as_string(__self: *@This()) []const u8 { return __self.body; } pub fn get(__self: *@This(), name: []const u8) ?[]const u8 { return __self.headers.get(name); } pub fn set(__self: *@This(), name: []const u8, value: []const u8) void { __self.headers.put(name, value) catch unreachable; } pub fn add_header(__self: *@This(), name: []const u8, value: []const u8) void { __self.set(name, value); } }.init()");
const mimeTextStruct = "struct { body: []const u8, subtype: []const u8 = \"plain\", headers: hashmap_helper.StringHashMap([]const u8) = .{}, pub fn as_string(__self: *@This()) []const u8 { return __self.body; } pub fn get(__self: *@This(), name: []const u8) ?[]const u8 { return __self.headers.get(name); } pub fn set(__self: *@This(), name: []const u8, value: []const u8) void { __self.headers.put(name, value) catch unreachable; } }";
...
pub const EmailMimeMultipartFuncs = std.StaticStringMap(h.H).initComptime(.{ .{ "MIMEMultipart", h.c("struct { subtype: []const u8 = \"mixed\", parts: std.ArrayList([]const u8) = .{}, headers: hashmap_helper.StringHashMap([]const u8) = .{}, pub fn attach(__self: *@This(), part: anytype) void { __self.parts.append(__global_allocator, part.as_string()) catch unreachable; } pub fn as_string(__self: *@This()) []const u8 { var result: std.ArrayList(u8) = .{}; for (__self.parts.items) |p| result.appendSlice(__global_allocator, p) catch unreachable; return result.items; } pub fn get(__self: *@This(), name: []const u8) ?[]const u8 { return __self.headers.get(name); } pub fn set(__self: *@This(), name: []const u8, value: []const u8) void { __self.headers.put(name, value) catch unreachable; } }{}") } });
