...
pub const HttpClientFuncs = std.StaticStringMap(h.H).initComptime(.{
    ...
    .{ "HTTPResponse", h.c(http_response_struct ++ "{}") },
});
...
pub const HttpCookiesFuncs = std.StaticStringMap(h.H).initComptime(.{
    .{ "SimpleCookie", h.c("struct { pub const Morsel = struct { key: []const u8 = \"\", value: []const u8 = \"\", coded_value: []const u8 = \"\", path: []const u8 = \"/\", domain: []const u8 = \"\", expires: []const u8 = \"\", max_age: ?i64 = null, secure: bool = false, httponly: bool = false, samesite: []const u8 = \"\", pub fn output(__self: *@This(), header: []const u8) []const u8 { _ = __self; _ = header; return \"\"; } pub fn js_output(__self: *@This()) []const u8 { _ = __self; return \"\"; } pub fn OutputString(__self: *@This()) []const u8 { _ = __self; return \"\"; } }; pub fn load(__self: *@This(), rawdata: anytype) void { _ = __self; _ = rawdata; } pub fn output(__self: *@This(), header: []const u8, sep: []const u8) []const u8 { _ = __self; _ = header; _ = sep; return \"\"; } pub fn js_output(__self: *@This()) []const u8 { _ = __self; return \"\"; } }{}") },
    .{ "BaseCookie", h.c("struct {}{}") },
});

// Connection methods with inline HTTPResponse definition
const conn_methods = ", socket: ?i64 = null, pub const HTTPResponse = " ++ http_response_struct ++ "; pub fn request(__self: *@This(), method: []const u8, url: []const u8, body: ?[]const u8, headers: anytype) void { _ = __self; _ = method; _ = url; _ = body; _ = headers; } pub fn getresponse(__self: *@This()) HTTPResponse { _ = __self; return HTTPResponse{}; } pub fn connect(__self: *@This()) void { _ = __self; } pub fn close(__self: *@This()) void { __self.socket = null; }";
fn genConn(self: *NativeCodegen, args: []ast.Node, comptime default_port: []const u8, comptime extra: []const u8) CodegenError!void {
    ...
    try self.emit(conn_methods ++ extra ++ " }{}");
}
...
fn genHTTPSConnection(self: *NativeCodegen, args: []ast.Node) CodegenError!void { try genConn(self, args, "443", ""); }
