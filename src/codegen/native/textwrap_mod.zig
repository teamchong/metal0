...
const shortenBody = "); if (_text.len <= _width) break :blk _text; if (_width <= 3) break :blk \"...\"; var _result = __global_allocator.alloc(u8, _width) catch break :blk _text; @memcpy(_result[0.._width-3], _text[0.._width-3]); @memcpy(_result[_width-3..], \"...\"); break :blk _result; }";

pub const Funcs = std.StaticStringMap(h.H).initComptime(.{
    .{ "wrap", genWrap }, .{ "fill", genFill },
    .{ "dedent", h.wrap("blk: { const _text = ", dedentBody, "\"\"") },
    .{ "indent", h.wrap2("blk: { const _text = ", "; const _prefix = ", indentBody, "\"\"") },
    .{ "shorten", h.wrap2("blk: { const _text = ", "; const _width: usize = @intCast(", shortenBody, "\"\"") },
