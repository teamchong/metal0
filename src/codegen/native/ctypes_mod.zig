...
pub const Funcs = std.StaticStringMap(ModuleHandler).initComptime(.{
    ...
    .{ "Union", genUnion },
    .{ "BigEndianStructure", genBigEndianStructure },
    .{ "LittleEndianStructure", genLittleEndianStructure },
    .{ "Array", genArrayType },
    .{ "POINTER", genPOINTER },
    .{ "pointer", genPointer },
    .{ "sizeof", genSizeof },
    ...
    .{ "set_last_error", genSetLastError },
    .{ "memmove", genMemmove },
    .{ "memset", genMemset },
    .{ "string_at", genStringAt },
    .{ "wstring_at", genWstringAt },
    .{ "CFUNCTYPE", genCFUNCTYPE },
    .{ "WINFUNCTYPE", genWINFUNCTYPE },
