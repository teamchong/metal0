...
/// spwd module functions (shadow password database - Unix)
const SpwdFuncs = FuncMap.initComptime(.{
    .{ "getspnam", spwd_mod.genGetspnam },
    .{ "getspall", spwd_mod.genGetspall },
    .{ "struct_spwd", spwd_mod.genStructSpwd },
});

/// tkinter module functions
const TkinterFuncs = FuncMap.initComptime(.{
    .{ "Tk", tkinter_mod.genTk },
    .{ "Frame", tkinter_mod.genFrame },
    .{ "Label", tkinter_mod.genLabel },
    .{ "Button", tkinter_mod.genButton },
    .{ "Entry", tkinter_mod.genEntry },
    .{ "Text", tkinter_mod.genText },
    .{ "Canvas", tkinter_mod.genCanvas },
    .{ "Listbox", tkinter_mod.genListbox },
    .{ "Menu", tkinter_mod.genMenu },
    .{ "Menubutton", tkinter_mod.genMenubutton },
    .{ "Scrollbar", tkinter_mod.genScrollbar },
    .{ "Scale", tkinter_mod.genScale },
    .{ "Spinbox", tkinter_mod.genSpinbox },
    .{ "Checkbutton", tkinter_mod.genCheckbutton },
    .{ "Radiobutton", tkinter_mod.genRadiobutton },
    .{ "Message", tkinter_mod.genMessage },
    .{ "Toplevel", tkinter_mod.genToplevel },
    .{ "PanedWindow", tkinter_mod.genPanedWindow },
    .{ "LabelFrame", tkinter_mod.genLabelFrame },
    .{ "PhotoImage", tkinter_mod.genPhotoImage },
    .{ "BitmapImage", tkinter_mod.genBitmapImage },
    .{ "StringVar", tkinter_mod.genStringVar },
    .{ "IntVar", tkinter_mod.genIntVar },
    .{ "DoubleVar", tkinter_mod.genDoubleVar },
    .{ "BooleanVar", tkinter_mod.genBooleanVar },
    .{ "mainloop", tkinter_mod.genMainloop },
    .{ "TclError", tkinter_mod.genTclError },
    .{ "END", tkinter_mod.genEND },
    .{ "LEFT", tkinter_mod.genLEFT },
    .{ "RIGHT", tkinter_mod.genRIGHT },
    .{ "TOP", tkinter_mod.genTOP },
    .{ "BOTTOM", tkinter_mod.genBOTTOM },
    .{ "CENTER", tkinter_mod.genCENTER },
    .{ "N", tkinter_mod.genN },
    .{ "S", tkinter_mod.genS },
    .{ "E", tkinter_mod.genE },
    .{ "W", tkinter_mod.genW },
    .{ "NE", tkinter_mod.genNE },
    .{ "NW", tkinter_mod.genNW },
    .{ "SE", tkinter_mod.genSE },
    .{ "SW", tkinter_mod.genSW },
    .{ "HORIZONTAL", tkinter_mod.genHORIZONTAL },
    .{ "VERTICAL", tkinter_mod.genVERTICAL },
    .{ "BOTH", tkinter_mod.genBOTH },
    .{ "X", tkinter_mod.genX },
    .{ "Y", tkinter_mod.genY },
    .{ "NONE", tkinter_mod.genNONE },
    .{ "RAISED", tkinter_mod.genRAISED },
    .{ "SUNKEN", tkinter_mod.genSUNKEN },
    .{ "FLAT", tkinter_mod.genFLAT },
    .{ "RIDGE", tkinter_mod.genRIDGE },
    .{ "GROOVE", tkinter_mod.genGROOVE },
    .{ "SOLID", tkinter_mod.genSOLID },
    .{ "NORMAL", tkinter_mod.genNORMAL },
    .{ "DISABLED", tkinter_mod.genDISABLED },
    .{ "ACTIVE", tkinter_mod.genACTIVE },
    .{ "HIDDEN", tkinter_mod.genHIDDEN },
    .{ "INSERT", tkinter_mod.genINSERT },
    .{ "SEL", tkinter_mod.genSEL },
    .{ "SEL_FIRST", tkinter_mod.genSEL_FIRST },
    .{ "SEL_LAST", tkinter_mod.genSEL_LAST },
    .{ "WORD", tkinter_mod.genWORD },
    .{ "CHAR", tkinter_mod.genCHAR },
});

/// turtle module functions
const TurtleFuncs = FuncMap.initComptime(.{
    .{ "Turtle", turtle_mod.genTurtle },
    .{ "Screen", turtle_mod.genScreen },
    .{ "forward", turtle_mod.genForward },
    .{ "fd", turtle_mod.genFd },
    .{ "backward", turtle_mod.genBackward },
    .{ "bk", turtle_mod.genBk },
    .{ "right", turtle_mod.genRight },
    .{ "rt", turtle_mod.genRt },
    .{ "left", turtle_mod.genLeft },
    .{ "lt", turtle_mod.genLt },
    .{ "goto", turtle_mod.genGoto },
    .{ "setpos", turtle_mod.genSetpos },
    .{ "setposition", turtle_mod.genSetposition },
    .{ "setx", turtle_mod.genSetx },
    .{ "sety", turtle_mod.genSety },
    .{ "setheading", turtle_mod.genSetheading },
    .{ "seth", turtle_mod.genSeth },
    .{ "home", turtle_mod.genHome },
    .{ "circle", turtle_mod.genCircle },
    .{ "dot", turtle_mod.genDot },
    .{ "stamp", turtle_mod.genStamp },
    .{ "clearstamp", turtle_mod.genClearstamp },
    .{ "clearstamps", turtle_mod.genClearstamps },
    .{ "undo", turtle_mod.genUndo },
    .{ "speed", turtle_mod.genSpeed },
    .{ "position", turtle_mod.genPosition },
    .{ "pos", turtle_mod.genPos },
    .{ "xcor", turtle_mod.genXcor },
    .{ "ycor", turtle_mod.genYcor },
    .{ "heading", turtle_mod.genHeading },
    .{ "distance", turtle_mod.genDistance },
    .{ "pendown", turtle_mod.genPendown },
    .{ "pd", turtle_mod.genPd },
    .{ "down", turtle_mod.genDown },
    .{ "penup", turtle_mod.genPenup },
    .{ "pu", turtle_mod.genPu },
    .{ "up", turtle_mod.genUp },
    .{ "pensize", turtle_mod.genPensize },
    .{ "width", turtle_mod.genWidth },
    .{ "pencolor", turtle_mod.genPencolor },
    .{ "fillcolor", turtle_mod.genFillcolor },
    .{ "color", turtle_mod.genColor },
    .{ "filling", turtle_mod.genFilling },
    .{ "begin_fill", turtle_mod.genBeginFill },
    .{ "end_fill", turtle_mod.genEndFill },
    .{ "reset", turtle_mod.genReset },
    .{ "clear", turtle_mod.genClear },
    .{ "write", turtle_mod.genWrite },
    .{ "showturtle", turtle_mod.genShowturtle },
    .{ "st", turtle_mod.genSt },
    .{ "hideturtle", turtle_mod.genHideturtle },
    .{ "ht", turtle_mod.genHt },
    .{ "isvisible", turtle_mod.genIsvisible },
    .{ "shape", turtle_mod.genShape },
    .{ "shapesize", turtle_mod.genShapesize },
    .{ "turtlesize", turtle_mod.genTurtlesize },
    .{ "bgcolor", turtle_mod.genBgcolor },
    .{ "bgpic", turtle_mod.genBgpic },
    .{ "done", turtle_mod.genDone },
    .{ "mainloop", turtle_mod.genMainloop },
    .{ "exitonclick", turtle_mod.genExitonclick },
    .{ "bye", turtle_mod.genBye },
    .{ "tracer", turtle_mod.genTracer },
    .{ "update", turtle_mod.genUpdate },
    .{ "delay", turtle_mod.genDelay },
    .{ "mode", turtle_mod.genMode },
    .{ "colormode", turtle_mod.genColormode },
    .{ "getcanvas", turtle_mod.genGetcanvas },
    .{ "getshapes", turtle_mod.genGetshapes },
    .{ "register_shape", turtle_mod.genRegisterShape },
    .{ "addshape", turtle_mod.genAddshape },
    .{ "turtles", turtle_mod.genTurtles },
    .{ "window_height", turtle_mod.genWindowHeight },
    .{ "window_width", turtle_mod.genWindowWidth },
    .{ "setup", turtle_mod.genSetup },
    .{ "title", turtle_mod.genTitle },
});

/// turtledemo module functions
const TurtledemoFuncs = FuncMap.initComptime(.{
    .{ "main", turtledemo_mod.genMain },
    .{ "bytedesign", turtledemo_mod.genBytedesign },
    .{ "chaos", turtledemo_mod.genChaos },
    .{ "clock", turtledemo_mod.genClock },
    .{ "colormixer", turtledemo_mod.genColormixer },
    .{ "forest", turtledemo_mod.genForest },
    .{ "fractalcurves", turtledemo_mod.genFractalcurves },
    .{ "lindenmayer", turtledemo_mod.genLindenmayer },
    .{ "minimal_hanoi", turtledemo_mod.genMinimalHanoi },
    .{ "nim", turtledemo_mod.genNim },
    .{ "paint", turtledemo_mod.genPaint },
    .{ "peace", turtledemo_mod.genPeace },
    .{ "penrose", turtledemo_mod.genPenrose },
    .{ "planet_and_moon", turtledemo_mod.genPlanetAndMoon },
    .{ "rosette", turtledemo_mod.genRosette },
    .{ "round_dance", turtledemo_mod.genRoundDance },
    .{ "sorting_animate", turtledemo_mod.genSortingAnimate },
    .{ "tree", turtledemo_mod.genTree },
    .{ "two_canvases", turtledemo_mod.genTwoCanvases },
    .{ "yinyang", turtledemo_mod.genYinyang },
});

/// idlelib module functions
const IdlelibFuncs = FuncMap.initComptime(.{
    .{ "idle", idlelib_mod.genIdle },
    .{ "PyShell", idlelib_mod.genPyShell },
    .{ "EditorWindow", idlelib_mod.genEditorWindow },
    .{ "FileList", idlelib_mod.genFileList },
    .{ "OutputWindow", idlelib_mod.genOutputWindow },
    .{ "ColorDelegator", idlelib_mod.genColorDelegator },
    .{ "UndoDelegator", idlelib_mod.genUndoDelegator },
    .{ "Percolator", idlelib_mod.genPercolator },
    .{ "AutoComplete", idlelib_mod.genAutoComplete },
    .{ "AutoExpand", idlelib_mod.genAutoExpand },
    .{ "CallTips", idlelib_mod.genCallTips },
    .{ "Debugger", idlelib_mod.genDebugger },
    .{ "StackViewer", idlelib_mod.genStackViewer },
    .{ "ObjectBrowser", idlelib_mod.genObjectBrowser },
    .{ "PathBrowser", idlelib_mod.genPathBrowser },
    .{ "ClassBrowser", idlelib_mod.genClassBrowser },
    .{ "ModuleBrowser", idlelib_mod.genModuleBrowser },
    .{ "SearchDialog", idlelib_mod.genSearchDialog },
    .{ "SearchDialogBase", idlelib_mod.genSearchDialogBase },
    .{ "SearchEngine", idlelib_mod.genSearchEngine },
    .{ "ReplaceDialog", idlelib_mod.genReplaceDialog },
    .{ "GrepDialog", idlelib_mod.genGrepDialog },
    .{ "Bindings", idlelib_mod.genBindings },
    .{ "configHandler", idlelib_mod.genConfigHandler },
    .{ "configDialog", idlelib_mod.genConfigDialog },
    .{ "IOBinding", idlelib_mod.genIOBinding },
    .{ "MultiCall", idlelib_mod.genMultiCall },
    .{ "WidgetRedirector", idlelib_mod.genWidgetRedirector },
    .{ "Delegator", idlelib_mod.genDelegator },
    .{ "rpc", idlelib_mod.genRpc },
    .{ "run", idlelib_mod.genRun },
    .{ "RemoteDebugger", idlelib_mod.genRemoteDebugger },
    .{ "RemoteObjectBrowser", idlelib_mod.genRemoteObjectBrowser },
    .{ "ToolTip", idlelib_mod.genToolTip },
    .{ "TreeWidget", idlelib_mod.genTreeWidget },
    .{ "ZoomHeight", idlelib_mod.genZoomHeight },
});

/// winreg module functions (Windows only)
const WinregFuncs = FuncMap.initComptime(.{
    .{ "CloseKey", winreg_mod.genCloseKey },
    .{ "ConnectRegistry", winreg_mod.genConnectRegistry },
    .{ "CreateKey", winreg_mod.genCreateKey },
    .{ "CreateKeyEx", winreg_mod.genCreateKeyEx },
    .{ "DeleteKey", winreg_mod.genDeleteKey },
    .{ "DeleteKeyEx", winreg_mod.genDeleteKeyEx },
    .{ "DeleteValue", winreg_mod.genDeleteValue },
    .{ "EnumKey", winreg_mod.genEnumKey },
    .{ "EnumValue", winreg_mod.genEnumValue },
    .{ "ExpandEnvironmentStrings", winreg_mod.genExpandEnvironmentStrings },
    .{ "FlushKey", winreg_mod.genFlushKey },
    .{ "LoadKey", winreg_mod.genLoadKey },
    .{ "OpenKey", winreg_mod.genOpenKey },
    .{ "OpenKeyEx", winreg_mod.genOpenKeyEx },
    .{ "QueryInfoKey", winreg_mod.genQueryInfoKey },
    .{ "QueryValue", winreg_mod.genQueryValue },
    .{ "QueryValueEx", winreg_mod.genQueryValueEx },
    .{ "SaveKey", winreg_mod.genSaveKey },
    .{ "SetValue", winreg_mod.genSetValue },
    .{ "SetValueEx", winreg_mod.genSetValueEx },
    .{ "DisableReflectionKey", winreg_mod.genDisableReflectionKey },
    .{ "EnableReflectionKey", winreg_mod.genEnableReflectionKey },
    .{ "QueryReflectionKey", winreg_mod.genQueryReflectionKey },
    .{ "HKEY_CLASSES_ROOT", winreg_mod.genHKEY_CLASSES_ROOT },
    .{ "HKEY_CURRENT_USER", winreg_mod.genHKEY_CURRENT_USER },
    .{ "HKEY_LOCAL_MACHINE", winreg_mod.genHKEY_LOCAL_MACHINE },
    .{ "HKEY_USERS", winreg_mod.genHKEY_USERS },
    .{ "HKEY_PERFORMANCE_DATA", winreg_mod.genHKEY_PERFORMANCE_DATA },
    .{ "HKEY_CURRENT_CONFIG", winreg_mod.genHKEY_CURRENT_CONFIG },
    .{ "HKEY_DYN_DATA", winreg_mod.genHKEY_DYN_DATA },
    .{ "KEY_ALL_ACCESS", winreg_mod.genKEY_ALL_ACCESS },
    .{ "KEY_WRITE", winreg_mod.genKEY_WRITE },
    .{ "KEY_READ", winreg_mod.genKEY_READ },
    .{ "KEY_EXECUTE", winreg_mod.genKEY_EXECUTE },
    .{ "KEY_QUERY_VALUE", winreg_mod.genKEY_QUERY_VALUE },
    .{ "KEY_SET_VALUE", winreg_mod.genKEY_SET_VALUE },
    .{ "KEY_CREATE_SUB_KEY", winreg_mod.genKEY_CREATE_SUB_KEY },
    .{ "KEY_ENUMERATE_SUB_KEYS", winreg_mod.genKEY_ENUMERATE_SUB_KEYS },
    .{ "KEY_NOTIFY", winreg_mod.genKEY_NOTIFY },
    .{ "KEY_CREATE_LINK", winreg_mod.genKEY_CREATE_LINK },
    .{ "KEY_WOW64_64KEY", winreg_mod.genKEY_WOW64_64KEY },
    .{ "KEY_WOW64_32KEY", winreg_mod.genKEY_WOW64_32KEY },
    .{ "REG_NONE", winreg_mod.genREG_NONE },
    .{ "REG_SZ", winreg_mod.genREG_SZ },
    .{ "REG_EXPAND_SZ", winreg_mod.genREG_EXPAND_SZ },
    .{ "REG_BINARY", winreg_mod.genREG_BINARY },
    .{ "REG_DWORD", winreg_mod.genREG_DWORD },
    .{ "REG_DWORD_LITTLE_ENDIAN", winreg_mod.genREG_DWORD_LITTLE_ENDIAN },
    .{ "REG_DWORD_BIG_ENDIAN", winreg_mod.genREG_DWORD_BIG_ENDIAN },
    .{ "REG_LINK", winreg_mod.genREG_LINK },
    .{ "REG_MULTI_SZ", winreg_mod.genREG_MULTI_SZ },
    .{ "REG_RESOURCE_LIST", winreg_mod.genREG_RESOURCE_LIST },
    .{ "REG_FULL_RESOURCE_DESCRIPTOR", winreg_mod.genREG_FULL_RESOURCE_DESCRIPTOR },
    .{ "REG_RESOURCE_REQUIREMENTS_LIST", winreg_mod.genREG_RESOURCE_REQUIREMENTS_LIST },
    .{ "REG_QWORD", winreg_mod.genREG_QWORD },
    .{ "REG_QWORD_LITTLE_ENDIAN", winreg_mod.genREG_QWORD_LITTLE_ENDIAN },
});

/// winsound module functions (Windows only)
const WinsoundFuncs = FuncMap.initComptime(.{
    .{ "Beep", winsound_mod.genBeep },
    .{ "PlaySound", winsound_mod.genPlaySound },
    .{ "MessageBeep", winsound_mod.genMessageBeep },
    .{ "SND_FILENAME", winsound_mod.genSND_FILENAME },
    .{ "SND_ALIAS", winsound_mod.genSND_ALIAS },
    .{ "SND_LOOP", winsound_mod.genSND_LOOP },
    .{ "SND_MEMORY", winsound_mod.genSND_MEMORY },
    .{ "SND_PURGE", winsound_mod.genSND_PURGE },
    .{ "SND_ASYNC", winsound_mod.genSND_ASYNC },
    .{ "SND_NODEFAULT", winsound_mod.genSND_NODEFAULT },
    .{ "SND_NOSTOP", winsound_mod.genSND_NOSTOP },
    .{ "SND_NOWAIT", winsound_mod.genSND_NOWAIT },
    .{ "MB_ICONASTERISK", winsound_mod.genMB_ICONASTERISK },
    .{ "MB_ICONEXCLAMATION", winsound_mod.genMB_ICONEXCLAMATION },
    .{ "MB_ICONHAND", winsound_mod.genMB_ICONHAND },
    .{ "MB_ICONQUESTION", winsound_mod.genMB_ICONQUESTION },
    .{ "MB_OK", winsound_mod.genMB_OK },
});
...
const ModuleMap = std.StaticStringMap(FuncMap).initComptime(.{
    ...
    .{ "spwd", SpwdFuncs },
    .{ "tkinter", TkinterFuncs },
    .{ "turtle", TurtleFuncs },
    .{ "turtledemo", TurtledemoFuncs },
    .{ "idlelib", IdlelibFuncs },
    .{ "winreg", WinregFuncs },
    .{ "winsound", WinsoundFuncs },
});
