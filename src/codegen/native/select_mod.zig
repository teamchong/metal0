...
/// DRY: Uses h.c(), h.I16() factories for constants
...
pub const Funcs = std.StaticStringMap(h.H).initComptime(.{
    // Complex struct constructors
    .{ "select", h.c(".{ &[_]i64{}, &[_]i64{}, &[_]i64{} }") },
    .{ "poll", h.c(poll_struct) },
    .{ "epoll", h.c(epoll_struct) },
    .{ "devpoll", h.c(devpoll_struct) },
    .{ "kqueue", h.c(kqueue_struct) },
    .{ "kevent", h.c(kevent_struct) },
    // POLL* constants (i16)
    .{ "POLLIN", h.c("@as(i16, 0x0001)") },
    .{ "POLLPRI", h.c("@as(i16, 0x0002)") },
    .{ "POLLOUT", h.c("@as(i16, 0x0004)") },
    .{ "POLLERR", h.c("@as(i16, 0x0008)") },
    .{ "POLLHUP", h.c("@as(i16, 0x0010)") },
    .{ "POLLNVAL", h.c("@as(i16, 0x0020)") },
    // EPOLL* constants (i32)
    .{ "EPOLLIN", h.c("@as(i32, 0x001)") },
    .{ "EPOLLOUT", h.c("@as(i32, 0x004)") },
    .{ "EPOLLPRI", h.c("@as(i32, 0x002)") },
    .{ "EPOLLERR", h.c("@as(i32, 0x008)") },
    .{ "EPOLLHUP", h.c("@as(i32, 0x010)") },
    .{ "EPOLLET", h.c("@as(i32, 0x80000000)") },
    .{ "EPOLLONESHOT", h.c("@as(i32, 0x40000000)") },
    .{ "EPOLLEXCLUSIVE", h.c("@as(i32, 0x10000000)") },
    .{ "EPOLLRDHUP", h.c("@as(i32, 0x2000)") },
    .{ "EPOLLRDNORM", h.c("@as(i32, 0x040)") },
    .{ "EPOLLRDBAND", h.c("@as(i32, 0x080)") },
    .{ "EPOLLWRNORM", h.c("@as(i32, 0x100)") },
    .{ "EPOLLWRBAND", h.c("@as(i32, 0x200)") },
    .{ "EPOLLMSG", h.c("@as(i32, 0x400)") },
    // KQ_FILTER_* constants (negative i16)
    .{ "KQ_FILTER_READ", h.I16(-1) },
    .{ "KQ_FILTER_WRITE", h.I16(-2) },
    .{ "KQ_FILTER_AIO", h.I16(-3) },
    .{ "KQ_FILTER_VNODE", h.I16(-4) },
    .{ "KQ_FILTER_PROC", h.I16(-5) },
    .{ "KQ_FILTER_SIGNAL", h.I16(-6) },
    .{ "KQ_FILTER_TIMER", h.I16(-7) },
    // KQ_EV_* constants (u16)
    .{ "KQ_EV_ADD", h.c("@as(u16, 0x0001)") },
    .{ "KQ_EV_DELETE", h.c("@as(u16, 0x0002)") },
    .{ "KQ_EV_ENABLE", h.c("@as(u16, 0x0004)") },
    .{ "KQ_EV_DISABLE", h.c("@as(u16, 0x0008)") },
    .{ "KQ_EV_ONESHOT", h.c("@as(u16, 0x0010)") },
    .{ "KQ_EV_CLEAR", h.c("@as(u16, 0x0020)") },
    .{ "KQ_EV_EOF", h.c("@as(u16, 0x8000)") },
    .{ "KQ_EV_ERROR", h.c("@as(u16, 0x4000)") },
});
