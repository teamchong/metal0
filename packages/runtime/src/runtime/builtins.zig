...
pub const bytes_factory = types_mod.bytes_callable;
pub const bytearray_factory = types_mod.bytearray_callable;
pub const memoryview_factory = types_mod.memoryview_callable;
