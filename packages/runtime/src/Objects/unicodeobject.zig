...
const core = @import("stringlib/core.zig");
const transform = @import("stringlib/transform.zig");
const search = @import("stringlib/search.zig");
const manipulate = @import("stringlib/manipulate.zig");
