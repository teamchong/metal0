...
//!
//! Mirrors: CPython Lib/encodings/cp1256.py

const std = @import("std");
const charmap = @import("charmap.zig");

pub const name = "cp1256";
pub const aliases = [_][]const u8{ "windows-1256" };
...
const decode_table: [256]u21 = blk: {
    ...
    table[0x81] = 0x067E; // ARABIC LETTER PEH
    ...
    table[0x8A] = 0x0679; // ARABIC LETTER TTEH
    table[0x8B] = 0x2039; // SINGLE LEFT-POINTING ANGLE QUOTATION MARK
    table[0x8C] = 0x0152; // LATIN CAPITAL LIGATURE OE
    table[0x8D] = 0x0686; // ARABIC LETTER TCHEH
    table[0x8E] = 0x0698; // ARABIC LETTER JEH
    table[0x8F] = 0x0688; // ARABIC LETTER DDAL
    table[0x90] = 0x06AF; // ARABIC LETTER GAF
    ...
    table[0x98] = 0x06A9; // ARABIC LETTER KEHEH
    table[0x99] = 0x2122; // TRADE MARK SIGN
    table[0x9A] = 0x0691; // ARABIC LETTER RREH
    table[0x9B] = 0x203A; // SINGLE RIGHT-POINTING ANGLE QUOTATION MARK
    table[0x9C] = 0x0153; // LATIN SMALL LIGATURE OE
    table[0x9D] = 0x200C; // ZERO WIDTH NON-JOINER
    table[0x9E] = 0x200D; // ZERO WIDTH JOINER
    table[0x9F] = 0x06BA; // ARABIC LETTER NOON GHUNNA
    // 0xA0-0xBF
    table[0xA0] = 0x00A0; // NO-BREAK SPACE
    table[0xA1] = 0x060C; // ARABIC COMMA
    ...
    table[0xAA] = 0x06BE; // ARABIC LETTER HEH DOACHASHMEE
    ...
    table[0xBA] = 0x061B; // ARABIC SEMICOLON
    ...
    // 0xC0-0xFF: Arabic letters and Latin mix
    table[0xC0] = 0x06C1; // ARABIC LETTER HEH GOAL
    ...
    table[0xD8] = 0x0637; // ARABIC LETTER TAH
    table[0xD9] = 0x0638; // ARABIC LETTER ZAH
    table[0xDA] = 0x0639; // ARABIC LETTER AIN
    table[0xDB] = 0x063A; // ARABIC LETTER GHAIN
    table[0xDC] = 0x0640; // ARABIC TATWEEL
    table[0xDD] = 0x0641; // ARABIC LETTER FEH
    table[0xDE] = 0x0642; // ARABIC LETTER QAF
    table[0xDF] = 0x0643; // ARABIC LETTER KAF
    table[0xE0] = 0x00E0; // LATIN SMALL LETTER A WITH GRAVE
    table[0xE1] = 0x0644; // ARABIC LETTER LAM
    table[0xE2] = 0x00E2; // LATIN SMALL LETTER A WITH CIRCUMFLEX
    table[0xE3] = 0x0645; // ARABIC LETTER MEEM
    table[0xE4] = 0x0646; // ARABIC LETTER NOON
    table[0xE5] = 0x0647; // ARABIC LETTER HEH
    table[0xE6] = 0x0648; // ARABIC LETTER WAW
    ...
    table[0xEC] = 0x0649; // ARABIC LETTER ALEF MAKSURA
    table[0xED] = 0x064A; // ARABIC LETTER YEH
    table[0xEE] = 0x00EE; // LATIN SMALL LETTER I WITH CIRCUMFLEX
    table[0xEF] = 0x00EF; // LATIN SMALL LETTER I WITH DIAERESIS
    table[0xF0] = 0x064B; // ARABIC FATHATAN
    table[0xF1] = 0x064C; // ARABIC DAMMATAN
    table[0xF2] = 0x064D; // ARABIC KASRATAN
    table[0xF3] = 0x064E; // ARABIC FATHA
    ...
    table[0xF8] = 0x0651; // ARABIC SHADDA
    table[0xF9] = 0x00F9; // LATIN SMALL LETTER U WITH GRAVE
    table[0xFA] = 0x0652; // ARABIC SUKUN
