...
//!
//! Mirrors: CPython Lib/encodings/iso8859_14.py

const std = @import("std");
const charmap = @import("charmap.zig");

pub const name = "iso8859-14";
pub const aliases = [_][]const u8{ "iso-8859-14", "latin8", "l8", "iso_8859_14", "celtic" };

/// ISO-8859-14 decode table
const decode_table: [256]u21 = blk: {
    ...
    table[0xA1] = 0x1E02; // LATIN CAPITAL LETTER B WITH DOT ABOVE
    table[0xA2] = 0x1E03; // LATIN SMALL LETTER B WITH DOT ABOVE
    table[0xA3] = 0x00A3; // POUND SIGN
    table[0xA4] = 0x010A; // LATIN CAPITAL LETTER C WITH DOT ABOVE
    table[0xA5] = 0x010B; // LATIN SMALL LETTER C WITH DOT ABOVE
    table[0xA6] = 0x1E0A; // LATIN CAPITAL LETTER D WITH DOT ABOVE
    table[0xA7] = 0x00A7; // SECTION SIGN
    table[0xA8] = 0x1E80; // LATIN CAPITAL LETTER W WITH GRAVE
    table[0xA9] = 0x00A9; // COPYRIGHT SIGN
    table[0xAA] = 0x1E82; // LATIN CAPITAL LETTER W WITH ACUTE
    table[0xAB] = 0x1E0B; // LATIN SMALL LETTER D WITH DOT ABOVE
    table[0xAC] = 0x1EF2; // LATIN CAPITAL LETTER Y WITH GRAVE
    table[0xAD] = 0x00AD; // SOFT HYPHEN
    table[0xAE] = 0x00AE; // REGISTERED SIGN
    table[0xAF] = 0x0178; // LATIN CAPITAL LETTER Y WITH DIAERESIS
    table[0xB0] = 0x1E1E; // LATIN CAPITAL LETTER F WITH DOT ABOVE
    table[0xB1] = 0x1E1F; // LATIN SMALL LETTER F WITH DOT ABOVE
    table[0xB2] = 0x0120; // LATIN CAPITAL LETTER G WITH DOT ABOVE
    table[0xB3] = 0x0121; // LATIN SMALL LETTER G WITH DOT ABOVE
    table[0xB4] = 0x1E40; // LATIN CAPITAL LETTER M WITH DOT ABOVE
    table[0xB5] = 0x1E41; // LATIN SMALL LETTER M WITH DOT ABOVE
    table[0xB6] = 0x00B6; // PILCROW SIGN
    table[0xB7] = 0x1E56; // LATIN CAPITAL LETTER P WITH DOT ABOVE
    table[0xB8] = 0x1E81; // LATIN SMALL LETTER W WITH GRAVE
    table[0xB9] = 0x1E57; // LATIN SMALL LETTER P WITH DOT ABOVE
    table[0xBA] = 0x1E83; // LATIN SMALL LETTER W WITH ACUTE
    table[0xBB] = 0x1E60; // LATIN CAPITAL LETTER S WITH DOT ABOVE
    table[0xBC] = 0x1EF3; // LATIN SMALL LETTER Y WITH GRAVE
    table[0xBD] = 0x1E84; // LATIN CAPITAL LETTER W WITH DIAERESIS
    table[0xBE] = 0x1E85; // LATIN SMALL LETTER W WITH DIAERESIS
    table[0xBF] = 0x1E61; // LATIN SMALL LETTER S WITH DOT ABOVE
    ...
    table[0xD0] = 0x0174; // LATIN CAPITAL LETTER W WITH CIRCUMFLEX
    ...
    table[0xD7] = 0x1E6A; // LATIN CAPITAL LETTER T WITH DOT ABOVE
    ...
    table[0xDE] = 0x0176; // LATIN CAPITAL LETTER Y WITH CIRCUMFLEX
    ...
    table[0xF0] = 0x0175; // LATIN SMALL LETTER W WITH CIRCUMFLEX
    ...
    table[0xF7] = 0x1E6B; // LATIN SMALL LETTER T WITH DOT ABOVE
    ...
    table[0xFE] = 0x0177; // LATIN SMALL LETTER Y WITH CIRCUMFLEX
