...
//!
//! Mirrors: CPython Lib/encodings/iso8859_2.py

const std = @import("std");
const charmap = @import("charmap.zig");

pub const name = "iso8859-2";
pub const aliases = [_][]const u8{ "iso-8859-2", "iso_8859_2", "latin2", "L2" };

/// ISO-8859-2 decode table
pub const decode_table: [256]u21 = .{
    ...
    // 0x80-0x9F: C1 controls (same as Latin-1)
    0x0080, 0x0081, 0x0082, 0x0083, 0x0084, 0x0085, 0x0086, 0x0087,
    0x0088, 0x0089, 0x008A, 0x008B, 0x008C, 0x008D, 0x008E, 0x008F,
    0x0090, 0x0091, 0x0092, 0x0093, 0x0094, 0x0095, 0x0096, 0x0097,
    0x0098, 0x0099, 0x009A, 0x009B, 0x009C, 0x009D, 0x009E, 0x009F,
    // 0xA0-0xFF: Latin-2 specific characters
...
pub const Codec = charmap.CharmapCodec(&decode_table, "iso8859-2");
