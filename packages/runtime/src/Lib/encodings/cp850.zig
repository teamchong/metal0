...
//!
//! Mirrors: CPython Lib/encodings/cp850.py

const std = @import("std");
const charmap = @import("charmap.zig");

pub const name = "cp850";
pub const aliases = [_][]const u8{ "850", "ibm850", "cspc850multilingual" };
...
pub const decode_table: [256]u21 = .{
    ...
    // 0x80-0xFF: Extended Latin characters
...
pub const Codec = charmap.CharmapCodec(&decode_table, "cp850");
