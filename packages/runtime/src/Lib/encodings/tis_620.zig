...
//!
//! Mirrors: CPython Lib/encodings/tis_620.py

const std = @import("std");
const charmap = @import("charmap.zig");

pub const name = "tis-620";
pub const aliases = [_][]const u8{ "tis_620", "tis620", "tis620-0" };

const UNDEF = charmap.UNDEFINED;

/// TIS-620 decode table
