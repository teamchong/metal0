...
//!
//! Mirrors: CPython Lib/encodings/cp860.py

const std = @import("std");
const charmap = @import("charmap.zig");

pub const name = "cp860";
pub const aliases = [_][]const u8{ "ibm860", "860" };
...
const decode_table: [256]u21 = blk: {
    ...
    table[0x84] = 0x00E3; // LATIN SMALL LETTER A WITH TILDE
    table[0x85] = 0x00E0; // LATIN SMALL LETTER A WITH GRAVE
    table[0x86] = 0x00C1; // LATIN CAPITAL LETTER A WITH ACUTE
    table[0x87] = 0x00E7; // LATIN SMALL LETTER C WITH CEDILLA
    table[0x88] = 0x00EA; // LATIN SMALL LETTER E WITH CIRCUMFLEX
    table[0x89] = 0x00CA; // LATIN CAPITAL LETTER E WITH CIRCUMFLEX
    table[0x8A] = 0x00E8; // LATIN SMALL LETTER E WITH GRAVE
    table[0x8B] = 0x00CD; // LATIN CAPITAL LETTER I WITH ACUTE
    table[0x8C] = 0x00D4; // LATIN CAPITAL LETTER O WITH CIRCUMFLEX
    table[0x8D] = 0x00EC; // LATIN SMALL LETTER I WITH GRAVE
    table[0x8E] = 0x00C3; // LATIN CAPITAL LETTER A WITH TILDE
    table[0x8F] = 0x00C2; // LATIN CAPITAL LETTER A WITH CIRCUMFLEX
    table[0x90] = 0x00C9; // LATIN CAPITAL LETTER E WITH ACUTE
    table[0x91] = 0x00C0; // LATIN CAPITAL LETTER A WITH GRAVE
    table[0x92] = 0x00C8; // LATIN CAPITAL LETTER E WITH GRAVE
    table[0x93] = 0x00F4; // LATIN SMALL LETTER O WITH CIRCUMFLEX
    table[0x94] = 0x00F5; // LATIN SMALL LETTER O WITH TILDE
    table[0x95] = 0x00F2; // LATIN SMALL LETTER O WITH GRAVE
    table[0x96] = 0x00DA; // LATIN CAPITAL LETTER U WITH ACUTE
    table[0x97] = 0x00F9; // LATIN SMALL LETTER U WITH GRAVE
    table[0x98] = 0x00CC; // LATIN CAPITAL LETTER I WITH GRAVE
    table[0x99] = 0x00D5; // LATIN CAPITAL LETTER O WITH TILDE
    ...
    table[0x9F] = 0x00D3; // LATIN CAPITAL LETTER O WITH ACUTE
    // 0xA0-0xAF
    ...
    table[0xA9] = 0x00D2; // LATIN CAPITAL LETTER O WITH GRAVE
