...
//!
//! Mirrors: CPython Lib/encodings/cp858.py

const std = @import("std");
const charmap = @import("charmap.zig");

pub const name = "cp858";
pub const aliases = [_][]const u8{ "ibm858", "858" };
...
const decode_table: [256]u21 = blk: {
    ...
    table[0x8D] = 0x00EC; // LATIN SMALL LETTER I WITH GRAVE
    ...
    table[0x98] = 0x00FF; // LATIN SMALL LETTER Y WITH DIAERESIS
    ...
    table[0xD0] = 0x00F0; // LATIN SMALL LETTER ETH
    table[0xD1] = 0x00D0; // LATIN CAPITAL LETTER ETH
    ...
    table[0xD5] = 0x20AC; // EURO SIGN (differs from CP850)
    ...
    table[0xE7] = 0x00FE; // LATIN SMALL LETTER THORN
    table[0xE8] = 0x00DE; // LATIN CAPITAL LETTER THORN
