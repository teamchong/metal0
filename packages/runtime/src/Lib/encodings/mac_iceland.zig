...
//!
//! Mirrors: CPython Lib/encodings/mac_iceland.py

const std = @import("std");
const charmap = @import("charmap.zig");

pub const name = "mac-iceland";
pub const aliases = [_][]const u8{ "mac_iceland", "maciceland" };

const UNDEF = charmap.UNDEFINED;

/// Mac Iceland decode table
const decode_table: [256]u21 = blk: {
    ...
    // 0xA0-0xAF
    table[0xA0] = 0x00DD; // LATIN CAPITAL LETTER Y WITH ACUTE
    ...
    table[0xDC] = 0x00D0; // LATIN CAPITAL LETTER ETH
    table[0xDD] = 0x00F0; // LATIN SMALL LETTER ETH
    table[0xDE] = 0x00DE; // LATIN CAPITAL LETTER THORN
    table[0xDF] = 0x00FE; // LATIN SMALL LETTER THORN
    // 0xE0-0xFF
    table[0xE0] = 0x00FD; // LATIN SMALL LETTER Y WITH ACUTE
