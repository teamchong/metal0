...
//!
//! Mirrors: CPython Lib/encodings/cp437.py

const std = @import("std");
const charmap = @import("charmap.zig");

pub const name = "cp437";
pub const aliases = [_][]const u8{ "437", "ibm437", "cspc8codepage437" };

/// CP437 decode table (IBM PC original)
pub const decode_table: [256]u21 = .{
    // 0x00-0x1F: Special characters (not C0 controls in CP437!)
...
pub const Codec = charmap.CharmapCodec(&decode_table, "cp437");
