...
//!
//! Mirrors: CPython Lib/encodings/cp866.py

const std = @import("std");
const charmap = @import("charmap.zig");

pub const name = "cp866";
pub const aliases = [_][]const u8{ "866", "ibm866", "csibm866" };
...
pub const decode_table: [256]u21 = .{
    ...
    // 0x80-0xAF: Cyrillic uppercase А-Я
...
pub const Codec = charmap.CharmapCodec(&decode_table, "cp866");
...
test "cp866 decode cyrillic" {
    // А (0x80 in CP866) = U+0410
