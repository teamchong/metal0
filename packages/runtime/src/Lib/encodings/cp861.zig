...
//!
//! Mirrors: CPython Lib/encodings/cp861.py

const std = @import("std");
const charmap = @import("charmap.zig");

pub const name = "cp861";
pub const aliases = [_][]const u8{ "ibm861", "861" };
...
const decode_table: [256]u21 = blk: {
    ...
    table[0x8B] = 0x00D0; // LATIN CAPITAL LETTER ETH
    table[0x8C] = 0x00F0; // LATIN SMALL LETTER ETH
    table[0x8D] = 0x00DE; // LATIN CAPITAL LETTER THORN
    ...
    table[0x95] = 0x00FE; // LATIN SMALL LETTER THORN
    table[0x96] = 0x00FB; // LATIN SMALL LETTER U WITH CIRCUMFLEX
    table[0x97] = 0x00DD; // LATIN CAPITAL LETTER Y WITH ACUTE
    table[0x98] = 0x00FD; // LATIN SMALL LETTER Y WITH ACUTE
    ...
    table[0xA4] = 0x00C1; // LATIN CAPITAL LETTER A WITH ACUTE
    table[0xA5] = 0x00CD; // LATIN CAPITAL LETTER I WITH ACUTE
    table[0xA6] = 0x00D3; // LATIN CAPITAL LETTER O WITH ACUTE
    table[0xA7] = 0x00DA; // LATIN CAPITAL LETTER U WITH ACUTE
