...
//!
//! Mirrors: CPython Lib/encodings/mac_croatian.py

const std = @import("std");
const charmap = @import("charmap.zig");

pub const name = "mac-croatian";
pub const aliases = [_][]const u8{ "mac_croatian", "maccroatian" };

const UNDEF = charmap.UNDEFINED;

/// Mac Croatian decode table
const decode_table: [256]u21 = blk: {
    ...
    table[0xC6] = 0x0106; // LATIN CAPITAL LETTER C WITH ACUTE
    ...
    table[0xD8] = 0xF8FF; // Apple logo (Private Use Area)
    table[0xD9] = 0x00A9; // COPYRIGHT SIGN
    table[0xDA] = 0x2044; // FRACTION SLASH
    table[0xDB] = 0x20AC; // EURO SIGN
    table[0xDC] = 0x2039; // SINGLE LEFT-POINTING ANGLE QUOTATION MARK
    table[0xDD] = 0x203A; // SINGLE RIGHT-POINTING ANGLE QUOTATION MARK
    table[0xDE] = 0x00C6; // LATIN CAPITAL LETTER AE
    table[0xDF] = 0x00BB; // RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK
    // 0xE0-0xFF
    table[0xE0] = 0x2013; // EN DASH
    ...
    table[0xE6] = 0x0107; // LATIN SMALL LETTER C WITH ACUTE
    ...
    table[0xF5] = 0x0131; // LATIN SMALL LETTER DOTLESS I
    table[0xF6] = 0x02C6; // MODIFIER LETTER CIRCUMFLEX ACCENT
    table[0xF7] = 0x02DC; // SMALL TILDE
    table[0xF8] = 0x00AF; // MACRON
    table[0xF9] = 0x03C0; // GREEK SMALL LETTER PI
    table[0xFA] = 0x00CB; // LATIN CAPITAL LETTER E WITH DIAERESIS
    table[0xFB] = 0x02DA; // RING ABOVE
    table[0xFC] = 0x00B8; // CEDILLA
    table[0xFD] = 0x00CA; // LATIN CAPITAL LETTER E WITH CIRCUMFLEX
    table[0xFE] = 0x00E6; // LATIN SMALL LETTER AE
