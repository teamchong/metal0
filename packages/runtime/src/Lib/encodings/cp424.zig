...
//!
//! Mirrors: CPython Lib/encodings/cp424.py

const std = @import("std");
const charmap = @import("charmap.zig");

pub const name = "cp424";
pub const aliases = [_][]const u8{ "ibm424", "424", "csibm424", "ebcdic-cp-he" };

const UNDEF = charmap.UNDEFINED;

/// CP424 decode table - EBCDIC Hebrew to Unicode
const decode_table: [256]u21 = blk: {
    ...
    table[0x41] = 0x05D0; // HEBREW LETTER ALEF
    table[0x42] = 0x05D1; // HEBREW LETTER BET
    table[0x43] = 0x05D2; // HEBREW LETTER GIMEL
    table[0x44] = 0x05D3; // HEBREW LETTER DALET
    table[0x45] = 0x05D4; // HEBREW LETTER HE
    table[0x46] = 0x05D5; // HEBREW LETTER VAV
    table[0x47] = 0x05D6; // HEBREW LETTER ZAYIN
    table[0x48] = 0x05D7; // HEBREW LETTER HET
    table[0x49] = 0x05D8; // HEBREW LETTER TET
    ...
    table[0x51] = 0x05D9; // HEBREW LETTER YOD
    table[0x52] = 0x05DA; // HEBREW LETTER FINAL KAF
    table[0x53] = 0x05DB; // HEBREW LETTER KAF
    table[0x54] = 0x05DC; // HEBREW LETTER LAMED
    table[0x55] = 0x05DD; // HEBREW LETTER FINAL MEM
    table[0x56] = 0x05DE; // HEBREW LETTER MEM
    table[0x57] = 0x05DF; // HEBREW LETTER FINAL NUN
    table[0x58] = 0x05E0; // HEBREW LETTER NUN
    table[0x59] = 0x05E1; // HEBREW LETTER SAMEKH
    ...
    table[0x62] = 0x05E2; // HEBREW LETTER AYIN
    table[0x63] = 0x05E3; // HEBREW LETTER FINAL PE
    table[0x64] = 0x05E4; // HEBREW LETTER PE
    table[0x65] = 0x05E5; // HEBREW LETTER FINAL TSADI
    table[0x66] = 0x05E6; // HEBREW LETTER TSADI
    table[0x67] = 0x05E7; // HEBREW LETTER QOF
    table[0x68] = 0x05E8; // HEBREW LETTER RESH
    table[0x69] = 0x05E9; // HEBREW LETTER SHIN
    ...
    table[0x70] = UNDEF; // UNDEFINED
    table[0x71] = 0x05EA; // HEBREW LETTER TAV
    table[0x72] = UNDEF; // UNDEFINED
    table[0x73] = UNDEF; // UNDEFINED
    table[0x74] = 0x00A0; // NO-BREAK SPACE
    table[0x75] = UNDEF; // UNDEFINED
    table[0x76] = UNDEF; // UNDEFINED
    table[0x77] = UNDEF; // UNDEFINED
    table[0x78] = 0x2017; // DOUBLE LOW LINE
    ...
    table[0x8C] = UNDEF; // UNDEFINED
    table[0x8D] = UNDEF; // UNDEFINED
    table[0x8E] = UNDEF; // UNDEFINED
    ...
    table[0x9A] = UNDEF; // UNDEFINED
    table[0x9B] = UNDEF; // UNDEFINED
    table[0x9C] = UNDEF; // UNDEFINED
    table[0x9D] = 0x00B8; // CEDILLA
    table[0x9E] = UNDEF; // UNDEFINED
    ...
    table[0xAA] = UNDEF; // UNDEFINED
    table[0xAB] = UNDEF; // UNDEFINED
    table[0xAC] = UNDEF; // UNDEFINED
    table[0xAD] = UNDEF; // UNDEFINED
    table[0xAE] = UNDEF; // UNDEFINED
    ...
    table[0xCB] = UNDEF; // UNDEFINED
    table[0xCC] = UNDEF; // UNDEFINED
    table[0xCD] = UNDEF; // UNDEFINED
    table[0xCE] = UNDEF; // UNDEFINED
    table[0xCF] = UNDEF; // UNDEFINED
    ...
    table[0xDB] = UNDEF; // UNDEFINED
    table[0xDC] = UNDEF; // UNDEFINED
    table[0xDD] = UNDEF; // UNDEFINED
    table[0xDE] = UNDEF; // UNDEFINED
    table[0xDF] = UNDEF; // UNDEFINED
    ...
    table[0xEB] = UNDEF; // UNDEFINED
    table[0xEC] = UNDEF; // UNDEFINED
    table[0xED] = UNDEF; // UNDEFINED
    table[0xEE] = UNDEF; // UNDEFINED
    table[0xEF] = UNDEF; // UNDEFINED
    ...
    table[0xFB] = UNDEF; // UNDEFINED
    table[0xFC] = UNDEF; // UNDEFINED
    table[0xFD] = UNDEF; // UNDEFINED
    table[0xFE] = UNDEF; // UNDEFINED
    table[0xFF] = 0x009F;
    break :blk table;
};
