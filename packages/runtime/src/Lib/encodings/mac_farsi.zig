...
//!
//! Mirrors: CPython Lib/encodings/mac_farsi.py

const std = @import("std");
const charmap = @import("charmap.zig");

pub const name = "mac-farsi";
pub const aliases = [_][]const u8{ "mac_farsi", "macfarsi" };

const UNDEF = charmap.UNDEFINED;

/// Mac Farsi decode table
const decode_table: [256]u21 = blk: {
    ...
    // 0xA0-0xCF: Various symbols and Arabic/Farsi
    ...
    table[0xB0] = 0x06F0; // EXTENDED ARABIC-INDIC DIGIT ZERO
    table[0xB1] = 0x06F1; // EXTENDED ARABIC-INDIC DIGIT ONE
    table[0xB2] = 0x06F2; // EXTENDED ARABIC-INDIC DIGIT TWO
    table[0xB3] = 0x06F3; // EXTENDED ARABIC-INDIC DIGIT THREE
    table[0xB4] = 0x06F4; // EXTENDED ARABIC-INDIC DIGIT FOUR
    table[0xB5] = 0x06F5; // EXTENDED ARABIC-INDIC DIGIT FIVE
    table[0xB6] = 0x06F6; // EXTENDED ARABIC-INDIC DIGIT SIX
    table[0xB7] = 0x06F7; // EXTENDED ARABIC-INDIC DIGIT SEVEN
    table[0xB8] = 0x06F8; // EXTENDED ARABIC-INDIC DIGIT EIGHT
    table[0xB9] = 0x06F9; // EXTENDED ARABIC-INDIC DIGIT NINE
    ...
    table[0xE3] = 0x06A9; // ARABIC LETTER KEHEH
    ...
    table[0xEA] = 0x06CC; // ARABIC LETTER FARSI YEH
