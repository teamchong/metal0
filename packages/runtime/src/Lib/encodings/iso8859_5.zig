...
//!
//! Mirrors: CPython Lib/encodings/iso8859_5.py

const std = @import("std");
const charmap = @import("charmap.zig");

pub const name = "iso8859-5";
pub const aliases = [_][]const u8{ "iso-8859-5", "iso_8859_5", "cyrillic" };

/// ISO-8859-5 decode table
...
pub const Codec = charmap.CharmapCodec(&decode_table, "iso8859-5");
...
test "iso8859_5 decode cyrillic" {
    // А (0xB0 in ISO-8859-5) = U+0410
    const result = try decode(std.testing.allocator, "\xb0", .strict);
