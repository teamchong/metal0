...
//!
//! Mirrors: CPython Lib/encodings/iso2022_jp_2004.py

const std = @import("std");
const iso2022_jp = @import("iso2022_jp.zig");

pub const name = "iso2022_jp_2004";
pub const aliases = [_][]const u8{ "iso2022jp-2004", "iso-2022-jp-2004" };
