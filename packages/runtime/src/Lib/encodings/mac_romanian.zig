...
//!
//! Mirrors: CPython Lib/encodings/mac_romanian.py

const std = @import("std");
const charmap = @import("charmap.zig");

pub const name = "mac-romanian";
pub const aliases = [_][]const u8{ "mac_romanian", "macromanian" };

const UNDEF = charmap.UNDEFINED;

/// Mac Romanian decode table
const decode_table: [256]u21 = blk: {
    ...
    table[0xAE] = 0x0102; // LATIN CAPITAL LETTER A WITH BREVE
    table[0xAF] = 0x0218; // LATIN CAPITAL LETTER S WITH COMMA BELOW
    // 0xB0-0xBF
    ...
    table[0xBE] = 0x0103; // LATIN SMALL LETTER A WITH BREVE
    table[0xBF] = 0x0219; // LATIN SMALL LETTER S WITH COMMA BELOW
    // 0xC0-0xCF
    ...
    table[0xDF] = 0x021B; // LATIN SMALL LETTER T WITH COMMA BELOW
    // 0xE0-0xFF
