//! CPython source: Lib/encodings/iso8859_11.py
//!
//! Thai alphabet (similar to TIS-620)
//!
//! Mirrors: CPython Lib/encodings/iso8859_11.py

const std = @import("std");
const charmap = @import("charmap.zig");

pub const name = "iso8859-11";
pub const aliases = [_][]const u8{ "iso-8859-11", "thai", "iso_8859_11" };

const UNDEF = charmap.UNDEFINED;

/// ISO-8859-11 decode table
const decode_table: [256]u21 = blk: {
    ...
    table[0xA0] = 0x00A0;
    // 0xA1-0xDA: Thai consonants and vowels
