//! test.test_multiprocessing_forkserver.test_process - Multiprocessing process tests (forkserver mode)
...
/// Process representation for multiprocessing
pub const Process = struct {
    ...
    pub fn start(self: *Process) !void {
        ...
        self.state = .started;
        // In real implementation, would fork/spawn
