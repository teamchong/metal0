//! test.test_unittest.test_functiontestcase - Unittest functiontestcase tests
...
test "functiontestcase_config" {
    const cfg = TestConfig.init("test_functiontestcase");
    try std.testing.expect(cfg.enabled);
}

test "functiontestcase_context" {
