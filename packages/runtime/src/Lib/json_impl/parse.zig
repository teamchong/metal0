...
const primitives = @import("parse_module/primitives.zig");
const number = @import("parse_module/number.zig");
const string = @import("parse_module/string.zig");
const array = @import("parse_module/array.zig");
const object = @import("parse_module/object.zig");
