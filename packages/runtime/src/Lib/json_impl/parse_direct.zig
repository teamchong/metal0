...
const primitives = @import("parse_direct_module/primitives.zig");
const number = @import("parse_direct_module/number.zig");
const string = @import("parse_direct_module/string.zig");
const array = @import("parse_direct_module/array.zig");
const object = @import("parse_direct_module/object.zig");
