...
pub inline fn isFloat(obj: *cpython.PyObject) bool {
    const pyf = @import("floatobject.zig");
...
pub inline fn isNone(obj: *cpython.PyObject) bool {
    const pynone = @import("noneobject.zig");
...
pub fn getIter(obj: *cpython.PyObject) ?*cpython.PyObject {
    ...
    if (isSequence(obj)) {
        const pyiter = @import("iterobject.zig");
...
pub fn createString(data: []const u8) ?*cpython.PyObject {
    const cpython_unicode = @import("../include/unicodeobject.zig");
...
pub fn errorOccurred() bool {
    const exc = @import("exceptions.zig");
...
pub const types = struct {
    ...
    // Numeric types
    pub const Long = @import("longobject.zig").PyLongObject;
    pub const Float = @import("floatobject.zig").PyFloatObject;
    pub const Bool = @import("boolobject.zig").PyBoolObject;
    pub const Complex = @import("complexobject.zig").PyComplexObject;

    // Sequence types
    pub const List = @import("listobject.zig").PyListObject;
    pub const Tuple = @import("tupleobject.zig").PyTupleObject;

    // Mapping types
    pub const Dict = @import("dictobject.zig").PyDictObject;
    pub const Set = @import("setobject.zig").PySetObject;
    pub const FrozenSet = @import("setobject.zig").PyFrozenSetObject;

    // String/bytes types (use cpython_unicode for full API)
    pub const Bytes = @import("bytesobject.zig").PyBytesObject;

    // Callable types
    pub const Method = @import("methodobject.zig").PyMethodObject;
    // Note: Function and CFunction types defined in cpython_module.zig (PyMethodDef)

    // Closure types
    pub const Cell = @import("cellobject.zig").PyCellObject;
    pub const Generator = @import("genobject.zig").PyGenObject;
    pub const Coroutine = @import("genobject.zig").PyCoroObject;
    pub const AsyncGenerator = @import("genobject.zig").PyAsyncGenObject;
    pub const Frame = @import("frameobject.zig").PyFrameObject;

    // Module types - cpython_module has the module creation API
    pub const Module = @import("../include/moduleobject.zig").PyModuleObject;
    pub const ModuleDef = @import("../include/moduleobject.zig").PyModuleDef;
    pub const MethodDef = @import("../include/moduleobject.zig").PyMethodDef;

    // Iterator types
    pub const SeqIter = @import("iterobject.zig").PySeqIterObject;
    pub const CallIter = @import("iterobject.zig").PyCallIterObject;

    // Range/slice types
    pub const Range = @import("rangeobject.zig").PyRangeObject;
    pub const Slice = @import("sliceobject.zig").PySliceObject;

    // Buffer types
    pub const MemoryView = @import("../include/memoryobject.zig").PyMemoryViewObject;
};

/// Get the canonical type object for a PyObject subtype
pub fn typeObject(comptime T: type) *cpython.PyTypeObject {
    return switch (T) {
        types.Long => &@import("longobject.zig").PyLong_Type,
        types.Float => &@import("floatobject.zig").PyFloat_Type,
        types.Bool => &@import("boolobject.zig").PyBool_Type,
        types.List => &@import("listobject.zig").PyList_Type,
        types.Tuple => &@import("tupleobject.zig").PyTuple_Type,
        types.Dict => &@import("dictobject.zig").PyDict_Type,
        types.Set => &@import("setobject.zig").PySet_Type,
        types.FrozenSet => &@import("setobject.zig").PyFrozenSet_Type,
        types.Bytes => &@import("bytesobject.zig").PyBytes_Type,
        types.Cell => &@import("cellobject.zig").PyCell_Type,
        types.Generator => &@import("genobject.zig").PyGen_Type,
        types.Coroutine => &@import("genobject.zig").PyCoro_Type,
        types.AsyncGenerator => &@import("genobject.zig").PyAsyncGen_Type,
        types.Frame => &@import("frameobject.zig").PyFrame_Type,
        types.Module => &@import("../include/moduleobject.zig").PyModule_Type,
        types.Range => &@import("rangeobject.zig").PyRange_Type,
        types.Slice => &@import("sliceobject.zig").PySlice_Type,
