/// ObjectPool - Generic thread-safe/thread-local object pooling
///
/// High-performance object pool using singly-linked list. Supports:
/// - Thread-local or shared pooling
/// - Maximum pool size limits
/// - Automatic reset on reuse
/// - Optional initialization function
const std = @import("std");

/// Singly-linked list for pool storage
...
/// Generic object pool with optional thread-safety and size limits
pub fn ObjectPool(
    comptime Type: type,
