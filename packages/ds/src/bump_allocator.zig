/// BumpAllocator - High-performance arena-style allocator
///
/// Fixed-size bump allocator with O(1) allocation and no TLB invalidation on reset.
/// Ideal for temporary allocations that can be bulk-freed.
